This is a readme file on the printf repo. This repo is created to do a peer programming on the alx SE printf project. The projects we will work on will be described above later.
